  ...
  return (
    <div className="group relative flex cursor-pointer items-center justify-center">
      <motion.img
        ...
        className="rounded-full border mx-auto border-gray-500 object-cover w-20 h-20  filter group-hover:grayscale transition duration-300 ease-in-out overflow-hidden "
      />
    </div>
  );
}
